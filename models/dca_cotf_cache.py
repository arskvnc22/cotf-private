...
class GPTBase(nn.Module):
    ...
    def forward(self,
        ...
        total_expected_length = (repeats + int(delayed_recall) )* T          # TODO done
        ...
        try:
            ...
            if delayed_recall:
                ...
                for block in self.transformer.h_mid:
                    ...
                    if diagnostics is not None:
                        diagnostics["repeat_index"] = rep_idx+1        # TODO
                        diagnostics["middle_layer_index"] = mid_idx + 1  # TODO
                        attention_diagnostics.append(diagnostics)
        ...
        if targets is not None:
            ...
            loss = None
        logits = logits if get_logits else None
        executed_repeats=repeats+int(delayed_recall)
