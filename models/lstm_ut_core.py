...
class GPTBase(nn.Module):
    ...
    def forward(
        ...
        # Prefix is an ordinary Transformer stack.
        x = run_transformer_blocks(
            x,
        ...
        for rep_idx in range(1, repeats + 1):
            ...
            # Run the entire shared middle stack without modifying the cell.
        ...
        # Suffix is also an ordinary Transformer stack.
        x = run_transformer_blocks(
            x,
