...
ITERATIONS=60000  # Training steps
...
EXPNAME="pilot2lstm_ut_core_40k_ndim_${N_EMBD}_${CELL_MODE}_beg_${N_LAYER_BEGIN}_mid_${N_REPEAT}_end_${N_LAYER_END}"
export WANDB_MODE=offline
export WANDB_RESUME="allow"
export WANDB_RUN_ID="RUN_40k_${EXPNAME}"
export WANDB_NAME="lstm_ut_core_${EXPNAME}"
